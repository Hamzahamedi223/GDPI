...
import { Plus, AlertCircle, FileText, Edit2, Trash2, Eye, Check, X, FileDown } from "lucide-react";
...
const Devis = () => {
  ...
  const handleExportPDF = () => {
    exportTableToPDF({
      ...
      filename: "devis",
      columns: ["Référence", "Date", "Fournisseur", "Montant Total", "Validité", "Statut"],
      rows: devis.map(d => [
        d.reference,
                    ...
                    <tfoot>
                      <tr>
                        ...
                        <td className="px-4 py-2 text-sm font-medium text-gray-900">
                          {formatCurrency(selectedDevis.totalAmount)}
                        </td>
                      </tr>
                    </tfoot>
                  </table>
