...
import { Plus, AlertCircle, FileText, Calendar, Edit2, Trash2, Download, Filter, FileDown } from "lucide-react";
...
const PurchaseOrder = () => {
  ...
  const handleExportPDF = () => {
    exportTableToPDF({
      ...
      filename: "bons_de_commande",
      columns: ["Référence", "Date", "Fournisseur", "Détails", "Statut"],
