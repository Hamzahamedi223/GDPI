...
const Equipments = () => {
  ...
  const handleExportPDF = () => {
    exportTableToPDF({
      ...
      columns: ["Nom", "Catégorie", "Modèle", "N° Série", "Service", "Statut", "Garantie", "Prix"],
        ...
        >
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-xl font-semibold text-gray-900 dark:text-white">{formatCurrency(totalPrice)}</p>
            </div>
          </div>
        </motion.div>
            ...
            <tbody className="bg-white dark:bg-slate-800 divide-y divide-gray-200 dark:divide-gray-700">
              {filteredEquipments.map((equipment) => (
                <tr key={equipment._id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900 dark:text-white">{formatCurrency(equipment.prix)}</div>
                  </td>
