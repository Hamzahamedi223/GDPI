...
import { Plus, AlertCircle, Tag, Building, Calendar, DollarSign, CheckCircle, XCircle, Edit2, Trash2, FileDown } from 'lucide-react';
...
export default function Piece() {
  ...
  const handleExportPDF = () => {
    exportTableToPDF({
      ...
      filename: 'pieces_de_rechange',
      columns: ['Nom', 'Numéro', 'Catégorie', 'Fournisseur', 'Service', 'Prix', 'Statut'],
