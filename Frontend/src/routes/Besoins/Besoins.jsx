...
import { AlertCircle, Search, Filter, Trash2, FileDown } from "lucide-react";
...
const Besoins = () => {
  ...
  const handleExportPDF = () => {
    exportTableToPDF({
      ...
      filename: "besoins",
      columns: ["Titre", "Description", "Service", "Quantité", "Statut", "Priorité", "Date"],
      rows: filteredBesoins.map(besoin => [
        besoin.title,
        besoin.description,
